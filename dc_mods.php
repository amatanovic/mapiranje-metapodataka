...
foreach ($elementi as $element) {
    if ($element->nodeName == "dc:title") {
        ...
        if ($element->nodeName == "dc:creator" || $element->nodeName == "dc:contributor") {
    	...
    	if ($element->nodeName == "dc:creator") {
    		$roleTerm = $novi_dokument->createElement("roleTerm", 'Creator');
    		}
    	else if ($element->nodeName == "dc:contributor") {
   ...
   if ($element->nodeName == "dc:format") {
    ...
    if ($element->nodeName == "dc:subject") { 
    ...
    if ($element->nodeName == "dc:description") { 
	...
	nastavak:
	 ...
	 if ($element->nodeName == "dc:source" || $element->nodeName == "dc:relation") { 
    ...
    if ($element->nodeName == "dc:identifier") {
        $iso3166Checked = 0;
